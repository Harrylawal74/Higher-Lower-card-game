...
public class LOButton : MonoBehaviour
{
    ...
    public void DealingLOCard()
    {
        ...
        //making it appear on the right when LO is pressed
        ...
        //when the LO button is pressed the LO value in "ComparingCardValues" is set to true
        ComparingCardValues.LO = true;
        
    }
    IEnumerator newCard(){
        //picks random number corrosponding to value of card
        //if the joker button in the joker script has been pressed then the joker can be used
